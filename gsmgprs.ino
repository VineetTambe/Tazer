...
void updateThinkspeak()
{
  ...
  GPRS_init();
  Serial1.println(String("GET http://api.thingspeak.com/update?api_key=Your_apikey&field1=") + latitude + "\r\n\x1A");
  delay(1000);
  ...
  GPRS_init();
  Serial1.println(String("GET http://api.thingspeak.com/update?api_key=F9B25YP488WM8R8O&field2=") + longitude + "\r\n\x1A");
  delay(1000);
